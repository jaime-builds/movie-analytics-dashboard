"""
Manual smoke test script for the Movie Analytics Dashboard API.

This is NOT part of the pytest suite. Run it against a live server to quickly
verify all API endpoints are responding correctly after a deployment or
environment change.
